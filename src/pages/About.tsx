        ...
        <div className="container mx-auto max-w-4xl">
          <div className="flex flex-col items-center justify-center mb-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-center">
              {lodgeInfo?.name || "Cruz da Excelência Maçônica Amor da Pátria"}
            </h1>
          </div>
        </div>
      </section>
        ...
        {worshipfulMasters.length > 0 && (
          <section className="mb-16">
            ...
            {worshipfulMasters.find(m => m.is_active) && (
              <Card className="shadow-elegant mb-12 bg-gradient-primary text-primary-foreground">
                <CardContent className="p-8">
                  <div className="flex flex-col items-center gap-6 text-center">
                    <div className="flex-shrink-0">
                      <Avatar className="w-40 h-40 border-4 border-primary-foreground shadow-glow">
                        <AvatarImage 
